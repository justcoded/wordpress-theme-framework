...
(function ($) {
	...
	$(document).on('sowsetupformfield', '.siteorigin-widget-field-type-post', function (e) {
		var $$ = $(this);
		...
		var refreshList = function () {
			...
			var types = $contentSearchInput.data('types');
			var postTypes = $contentSearchInput.data('postTypes');
			var ajaxData = {action: 'custom_post_search'};
		...
		$$.find('.siteorigin-widget-post-input').click(function () {
